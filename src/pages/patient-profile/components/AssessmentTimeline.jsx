import React, { useState, useMemo, useEffect } from 'react'; import Icon from '../../../components/AppIcon'; import Button from '../../../components/ui/Button';

const AssessmentTimeline = ({ assessments, currentLanguage }) => { const [selectedAssessmentId, setSelectedAssessmentId] = useState(null);

useEffect(() => { if (assessments && assessments.length > 0) { setSelectedAssessmentId(assessments[0]._id); } }, [assessments]);
...
{/* Timeline Navigation */}
{assessments.map((assessment, index) => { const icon = getPhaseIcon(assessment.status); const isSelected = selectedAssessmentId === assessment._id;
        return (
