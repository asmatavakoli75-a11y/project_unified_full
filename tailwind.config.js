  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'therapeutic-green': "var(--color-therapeutic-green)", // emerald-600
      ...
      fontFamily: {
        heading: ['Vazirmatn', 'sans-serif'], // Farsi headings
        body: ['Inter', 'sans-serif'], // Body text
        caption: ['Source Sans Pro', 'sans-serif'], // Captions and labels
        data: ['JetBrains Mono', 'monospace'], // Data and technical text
      ...
      gridTemplateColumns: {
        'clinical': 'repeat(auto-fit, minmax(300px, 1fr))',
        'assessment': '1fr 2fr',
        'dashboard': '250px 1fr',
      },
      maxWidth: {
